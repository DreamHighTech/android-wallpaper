...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_initVideo
...
/* pCodecCtx */
/* pFormatCtx */
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_loadVideo
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_prepareStorageFrame
(JNIEnv * env, jobject this)  {
...
jint Java_com_naturalclick_fbwallpaper_service_NativeCalls_getVideoWidth
(JNIEnv * env, jobject this)  {
  return pCodecCtx->width;
}

jint Java_com_naturalclick_fbwallpaper_service_NativeCalls_getVideoHeight
(JNIEnv * env, jobject this)  {
  return pCodecCtx->height;
}
 
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_getFrame
(JNIEnv * env, jobject this)  {
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_closeVideo
(JNIEnv * env, jobject this) {  
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_initOpenGL
(JNIEnv * env, jobject this)  {
  __android_log_print(ANDROID_LOG_DEBUG,
		      "NDK:",
		      "initOpenGL()"
  ...
  /* temp[128];
  memset(temp, 0x0, 128);
  sprintf(temp, "drawWidth:%d drawHeight:%d textureHeight:%d textureWidth:%d nTextureHeight:%d dPaddingX:%d dPaddingY:%d screenWidth:%d screenHeight:%d",
		  drawWidth, drawHeight, textureHeight, textureWidth, nTextureHeight, dPaddingX, dPaddingY, screenWidth, screenHeight);
  __android_log_print(ANDROID_LOG_DEBUG, "DrawFrame", temp);*/
  int max_viewport = screenHeight;
  if (screenWidth > screenHeight)
	  max_viewport = screenWidth;
  glViewport(0, 0, max_viewport, max_viewport);
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_drawFrame
(JNIEnv * env, jobject this)  {
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_closeOpenGL
(JNIEnv *env, jobject this) {
  glDeleteTextures(1, &textureConverted); 
}

void Java_com_naturalclick_fbwallpaper_service_NativeCalls_setScreenDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  screenWidth = w;
  screenHeight = h;
}

void Java_com_naturalclick_fbwallpaper_service_NativeCalls_setTextureDimensions
...
void Java_com_naturalclick_fbwallpaper_service_NativeCalls_setDrawDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  drawWidth = w;
  drawHeight = h;
}

void Java_com_naturalclick_fbwallpaper_service_NativeCalls_setScreenPadding
(JNIEnv *env, jobject this, jint w, jint h) {
  dPaddingX = w;
  dPaddingY = h;
}
