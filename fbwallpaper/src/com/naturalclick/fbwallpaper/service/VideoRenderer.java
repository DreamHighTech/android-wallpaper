...
public class VideoRenderer implements GLWallpaperService.Renderer {
    ...
    //pointers
    FootBallWallpaperService mParent;
    FootBallWallpaperService.VideoEngine mParentEngine;
    //lock
    ...
    public VideoRenderer(FootBallWallpaperService p, 
			   FootBallWallpaperService.VideoEngine e) {
	super();
	mParent = p;
	mParentEngine = e;
	runOnce = false;
